document.addEventListener("DOMContentLoaded", () => {
    ...
    orderDetailsProductQuatity.appendChild(quantityLabel);
    orderDetailsProductQuatity.appendChild(formGroup);
    orderDetailsProductActions.appendChild(orderDetailsProductQuatity);
